<template>
  <!-- forked from https://github.com/alessiomaffeis/vue-picture-input -->
...
export default {
  ...
  data () {
    return {
      ...
      strings: {
        ...
        drag: 'Drag an image or <br>click here',
        tap: 'Tap here to select a image <br>from your gallery',
        change: 'Change Image',
        aspect: 'Landscape/Portrait',
        remove: 'Remove Image',
        select: 'Select a Image',
  ...
  methods: {
    ...
    removeImage () {
      ...
      // this.$refs.previewCanvas.style.backgroundColor = 'hsla(198, 51%, 50%, 0.1)'
